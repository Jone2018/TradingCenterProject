...
function CLoginBox(props)
{
	...
	return (<div className="box login-box">
				<h3 className="title clearfix"><span className="tl pull-left">{props.title}</span> <span className="pull-right"><i className="icon-key txt-grey"></i></span></h3>
...
function CRadioBox(props)
{
	var txt = props.children || props.text;
	return (<label>
	<input type="radio" className={props.className} name={props.name} id={props.id} value={props.value} defaultChecked={props.checked} />
		{txt}
	</label>);
}
...
function CCheckbox(props)
{
	var txt = props.children || props.text;
	return (<label>
	<input type="checkbox" className={props.className} name={prop.name} id={props.id} value={props.value} defaultChecked={props.checked} />
		{txt}
	</label>);
}
